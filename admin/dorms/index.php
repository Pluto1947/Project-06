				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
			                    <button type="button" class="btn btn-flat p-1 btn-info btn-sm view_gallery" data-id="<?php echo $row['id'] ?>"><span class="fa fa-images"></span> View Gallery</button>
			                </td>
						</tr>
					<?php endwhile; ?>
				</tbody>
...
<script>
	$(document).ready(function(){
		...
		$('.view_gallery').click(function(){
            ...
            uni_modal("<i class='fa fa-images'></i> Dorm Gallery","dorms/view_gallery.php?id=" + id);
        })
		$('.table').dataTable({
			columnDefs: [
